...
|---|---|---|
| Install, the 4 apps, menu bar, settings, folder layout | `README.md`, `Package.swift`, `MacApp/Sources/Engine/*`, `MacApp/Sources/Core/AppSettings.swift`, `MacApp/Sources/Core/AppEnvironment.swift`, `docs/SIGNING.md` | `guide.html` → **Getting started** (`#ch-setup`); `quickstart.html` §1; FAQ "Getting started & the app" |
