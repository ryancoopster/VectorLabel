# VectorLabel - "Export All Circuits to VectorLabel"
# Exports EVERY ConnectCAD circuit on the ACTIVE DESIGN LAYER to:
...
#   "Export All Circuits to VectorLabel" → paste this whole file.
# (The companion "Export Selected Circuits to VectorLabel" uses export_selected.py.)
